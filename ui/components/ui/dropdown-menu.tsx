  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-md border border-gray-200 dark:border-gray-800 p-1 shadow-md",
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-[variant=destructive]:text-red-500 data-[variant=destructive]:focus:bg-red-500/10 data-[variant=destructive]:dark:focus:bg-red-500/20 data-[variant=destructive]:focus:text-red-500",
        className
      )}
      {...props}
    />
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn("py-1.5 px-2 text-sm font-medium", "data-[inset]:pl-8", className)}
      {...props}
    />
  );
}
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-md border border-gray-200 dark:border-gray-800 p-1 shadow-lg",
        "bg-white text-gray-900 dark:bg-gray-800 dark:text-gray-50",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
